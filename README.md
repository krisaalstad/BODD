...
and for an introduction to Gaussian Processes which are technically [infinite width neural networks](https://link.springer.com/book/10.1007/978-1-4612-0745-0) check out the classic GP bible by Rasmussen and Williams which is also freely available here:
